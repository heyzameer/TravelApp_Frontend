    ...
    return (
        <div className="relative h-[80vh] w-full bg-gray-900 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-4xl w-full">
                ...
                {/* Search Bar */}
                <form onSubmit={handleSearch} className="bg-white/10 backdrop-blur-md border border-white/20 p-2 md:p-3 rounded-full shadow-2xl max-w-3xl mx-auto flex flex-col md:flex-row gap-2">
                    <div className="flex-1 bg-white rounded-full flex items-center px-6 py-3 md:py-4">
